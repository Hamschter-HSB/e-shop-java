...
public class StockHistoryDialogViewModel {
    ...
    public StockHistoryDialogViewModel(DataPersister dataPersister) {
    ...
    private Map<String, Integer> graphData(int articleID) {
        ...
        List<StockChange> allStockChanges = dataPersister.readAllStockChanges().stream().toList();
        ...
        int bestand = dataPersister.readBulkArticle(articleID).getStock();
